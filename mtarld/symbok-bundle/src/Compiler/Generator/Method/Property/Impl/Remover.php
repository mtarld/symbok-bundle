...
class Remover extends AbstractPropertyMethodGenerator
{
    ...
    {
        return PropertyMethodNameBuilder::buildRemoverMethodName($this->property->getName());
    }
    ...
    protected function getCommentDocBlocks(): array
    {
        ...
        $docBlock = new DocBlock(
            'Removes ' . Singularize::getSingular($this->property->getName()) . ' to ' . $this->property->getName(),
            null,
            [
